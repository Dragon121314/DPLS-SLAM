...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        /**
         * @brief 单目初始化。// Matching for the Map Initialization (only used in the monocular case)
         * @param F1 单目初始化第一帧
         * @param F2 单目初始化第二帧
    ...
    protected:
        ...
        float mfNNratio;//最佳距离与次佳距离的比例
        bool mbCheckOrientation;//是否用特征点角度旋转差直方图剔除不好的点
    };
