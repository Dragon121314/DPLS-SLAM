...
public:
    ...
    bool both; //双目KB设置为true,见tracking的newparamloader函数
...
protected:
    ...
    cv::Mat mIm, mImRight;
    int N,N_l;
    vector<cv::KeyPoint> mvCurrentKeys,mvCurrentKeysRight,mvCurrentKeysDy;
    vector<bool> mvbMap, mvbVO, mvbInlerLine;
    bool mbOnlyTracking;
    ...
    //====================
    vector<KeyLine> mvCurrentKeys_l;
